...
document.querySelector(`fieldset`).children[2]
// 3. Log the number (using console.log) of children of all the `li` element inside the ul with class `topics`
let all = document.querySelector(`.topics`).querySelectorAll(`li`)
...
let label = document.querySelector(`fieldset`).querySelector(`label`)
// 7. Select the input of type `checkbox` with the `id` selector and store in `inputCheckbox`
let inputCheckbox = document.querySelector(`fieldset`).querySelector(`#remember`)
// 8. Select the input of type password using Attribute selectors. (eg: input[type="text"]) and store in `password`
let password = document.querySelector(`fieldset`).querySelector(`input[type = "password"]`)
...
let numberOfImg = document.querySelectorAll('img');
console.log(`The total number of img element is ${numberOfImg.length}`);
